...
│   ├── ebs-documentation-coverage.md  Inward-direction reconciliation of Oracle's own R12.2 documentation library (376 guides / 133,782 pages in ebs_docs/) against this model — 165 business products triaged, 90 already adjudicated, 50 recorded not-needed with reasons, 25 EDC gap rows all closed (batch 26–27); confirms Financials for Asia/Pacific carries no Philippine content
