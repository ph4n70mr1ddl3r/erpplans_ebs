...
│   ├── policies/                     ← Corporate Policy Manual — the 60 governing policies (POL-G/F/P/H/I/D/R/S/B) the workflows presume, mapped to owners, approvers & review cycles per W1729 (README.md = framework + master register + coverage-decision gap analysis; 9 domain manuals: governance incl. AML/competition/IP/ERM/board, finance, procurement, HR, IT security, privacy/records, retail ops incl. recall/gift cards/advertising/ticketing, HSE incl. live goods, continuity)
