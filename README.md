...
└── 07-methodology/              ← Technical system architecture and guidelines
    ...
    ├── verify-weak-anchor-demand.py  Weak-anchor demand verification generator (batch 43, 2026-09-23) — verifies the weak-anchor watchlist against virtual-gemba motion --full per-role annual demand; writes 01-model-company/workflows/weak-anchor-demand-verification.md (CONFIRMED / OVERLOAD / UNDER-UTILIZED / NO PARSED CADENCE verdicts; regenerate after any anchoring change)
