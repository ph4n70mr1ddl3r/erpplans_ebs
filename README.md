...
│   ├── workflows/                      5,430 workflows organized by value stream
...
│   │   ├── workflow-criticality-classification.md  Tier 1/2/3 confirmed priorities (5,453 rows)
...
├── bpmn/                        ← Generated BPMN 2.0 models (5,453 processes; mirrors the workflows/ tree; regenerates via 07-methodology/generate-bpmn.py)
...
└── 07-methodology/              ← Technical system architecture and guidelines
    ...
    ├── generate-bpmn.py             BPMN 2.0 generator — converts every workflow block in 01-model-company/workflows into validated .bpmn files under bpmn/ (5,453 processes, lanes, DI)
...
| Workflows (total) | **5,430** across 188 value streams, 569 process areas | `01-model-company/workflows/value-stream-index.md` |
...
```
   ...
   │                                                   │
   │  erp-requirements.md ←→ workflows/ (5,430 WF)    │
   │       ↕                    ↕                      │
