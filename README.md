...
│   ├── fit-gap-analysis.md            103-row capability disposition register (80 standard / 2 PER / 1 EXT / 1 LOC / 5 INT / 14 BUILD incl. 5 already-built platforms / 0 EDGE / 0 OPEN), EBS-held vs payroll-built statutory split, two-tier resolution record + 2026-09-15/16 EBS-exhaustion audits (eight passes) + 2026-09-21 EBS documentation-coverage closures (H12–H17), standard-first KPIs (77.7%)
...
│   ├── ebs-documentation-coverage.md  Inward-direction reconciliation of Oracle's own R12.2 documentation library (376 guides / 133,782 pages in ebs_docs/) against this model — 164 business products triaged, 107 already adjudicated, 32 recorded not-needed, 25 open EDC gap rows where EBS documents a capability the business needs and no workflow names it; confirms Financials for Asia/Pacific carries no Philippine content
