...
│   ├── optimal-table-of-organization.md  OFFICIAL table of organization of record — THE ACTUAL STRUCTURE (promoted 2026-09-14; gap-filled 2026-09-18; Trade dept disabled—prepared 2026-09-23 (x); IT's TPS build squad deferred—prepared 2026-09-23 (ad) — active HQ 518 / total 6,918): design HQ 532 / total 6,932, every HQ role defined in §5.3 (pre-optimization 362 / 6,762 retained as the §5.1 reference column; official elevation 2026-09-09; two-tier IT sourcing + agentic-AI model)
...
| Legal Entities | 5 |
| Total Headcount | 6,918 active (200 stores × 29 + 600 DC + 518 HQ; the TO's 6,932 design retains the disabled—prepared Trade department and the deferred—prepared TPS build squad) |
