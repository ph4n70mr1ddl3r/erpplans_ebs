...
└── 07-methodology/              ← Technical system architecture and guidelines
    ...
    ├── ai-first-operating-guide.md   The AI-first operating guide — ERP-agnostic doctrine (ten laws, six layers, capability contracts), sourcing neutrality, autonomy ladder, agent factory, the EKB as persistent memory + consistency engine, the no-confusion decision system, and the seven-phase adoption path (v1.24)
    ├── validate-repo.sh              Cross-reference validation (83 checks)
    ...
    ├── anchor-step-level-wave5.py  Step-level anchoring wave 5 (batch 47, 2026-09-23) — Senior FP&A Analyst (capex validation), Quality & Workforce Analyst (Tier-2 resolution QA), Sourcing & Screening Coordinator (pre-hire checks), Legal Counsel — Contracts (contract negotiation), Privacy Officer (consent governance), Promotions Specialist + Promotions & Vendor-Funding Coordinator (markdown ops); weak 56 → 53; verification reads 2 CONFIRMED / 2 OVERLOAD / 3 UNDER-UTILIZED / 46 NO PARSED CADENCE
    ...
    ├── anchor-step-level-wave4.py  Step-level anchoring wave 4 (batch 45, 2026-09-23) — Real-Estate & Site-Selection Analyst (PA-20.1 ×2), Maintenance & Projects Coordinator (PA-138.1), Sourcing & Screening Coordinator (PA-121.2), 3PL & Freight Specialist (PA-110.1), Senior LP Analytics Analyst (PA-23.1), Marketing Comms Specialist (PA-14.3), ESG Reporting & Data Analyst (PA-25.3), Wellness Coordinator (PA-83.3) elevated; weak 56 → 54; verification surfaces Senior LP Analytics Analyst at 1,014% utilization (capacity-decision candidate)
    ├── verify-weak-anchor-demand.py  Weak-anchor demand verification generator (batch 43; re-derived batch 49, 2026-09-25 — fixes the plural-unit duration defect in the motion engine's parse_minutes ('2 hours'/'4 hrs'/'24 hours/year' had silently measured 0 minutes across 3,775 corpus cells) and the dump parser's silent drop of thousands-separated utilizations, and adds the EXERCISED-THROUGH verdict measuring weak-anchor roles whose named cells attribute to the broader seats their cells resolve to; extended batch 50 with the MEASURED — CAPACITY UNMAPPED verdict (own-key demand against no mapped HC — IT product-model seats, the ASM alias gap) and the ZERO-DURATION / UNPARSEABLE-FREQ classification of the residue; verifies the weak-anchor watchlist against virtual-gemba motion --full per-role annual demand; writes 01-model-company/workflows/weak-anchor-demand-verification.md (CONFIRMED / OVERLOAD / UNDER-UTILIZED / EXERCISED-THROUGH / MEASURED — CAPACITY UNMAPPED / ZERO-DURATION / UNPARSEABLE-FREQ / NO PARSED CADENCE verdicts; regenerate after any anchoring change)
