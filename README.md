...
│   ├── fit-gap-analysis.md            79-row capability disposition register (54 standard / 2 PER / 2 EXT / 1 LOC / 5 INT / 15 BUILD incl. 5 already-built platforms / 0 EDGE / 0 OPEN), EBS-held vs payroll-built statutory split, two-tier resolution record, standard-first KPIs
