...
└── 07-methodology/              ← Technical system architecture and guidelines
    ...
    ├── ai-first-operating-guide.md   The AI-first operating guide — ERP-agnostic doctrine (ten laws, six layers, capability contracts), sourcing neutrality, autonomy ladder, agent factory, the EKB as persistent memory + consistency engine, the no-confusion decision system, and the seven-phase adoption path (v1.25)
    ├── validate-repo.sh              Cross-reference validation (84 checks)
