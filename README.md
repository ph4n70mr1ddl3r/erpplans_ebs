...
│   ├── fit-gap-analysis.md            97-row capability disposition register (74 standard / 2 PER / 1 EXT / 1 LOC / 5 INT / 14 BUILD incl. 5 already-built platforms / 0 EDGE / 0 OPEN), EBS-held vs payroll-built statutory split, two-tier resolution record + 2026-09-15/16 EBS-exhaustion audits (six passes), standard-first KPIs
