...
- **Total workflows referenced**: the core foundational workflows; mappings for the Expansion / Statutory / Gap-analysis value streams (VS-53–VS-192) are added incrementally and remain pending. The full 5,433-workflow / 188-value-stream inventory is in [value-stream-index.md](workflows/value-stream-index.md)
