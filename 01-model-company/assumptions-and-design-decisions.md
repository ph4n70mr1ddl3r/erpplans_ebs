...
| A2.6 | Revenue per employee | ~PHP 9.01M/year | Driven by optimized staffing and high automation (re-derived at the 2026-09-23 (ad) TPS-squad deferral: ~PHP 62.3B ÷ 6,918; was ~PHP 9.00M ÷ 6,925 at the (x) disablement and ~PHP 8.99M ÷ 6,932 before it); HQ rebalanced 315 → 357 (2026-06-20), then → 362 (2026-06-25), then promoted to the optimal structure HQ 511 (2026-09-14) and gap-filled to HQ 532 (2026-09-18) — see `optimal-table-of-organization.md` | Profile §4 |
