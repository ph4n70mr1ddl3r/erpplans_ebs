...
| A2.6 | Revenue per employee | ~PHP 9.01M/year | Driven by optimized staffing and high automation (re-derived at the 2026-09-23 (ah) OMO-squad deferral: ~PHP 62.3B ÷ 6,911; was ~PHP 9.01M ÷ 6,918 at the (ad) TPS-squad deferral and ~PHP 9.00M ÷ 6,925 at the (x) disablement); HQ rebalanced 315 → 357 (2026-06-20), then → 362 (2026-06-25), then promoted to the optimal structure HQ 511 (2026-09-14) and gap-filled to HQ 532 (2026-09-18) — see `optimal-table-of-organization.md` | Profile §4 |
...
| TPS build squad | **DEFERRED — PREPARED (2026-09-23 (ad)): the TPS build squad's 7 seats stand down with the trade desk disabled (x)** — the project-side workload (VS-74 job-site delivery, VS-77 material staging/phasing) is dormant; the 122-FTE 17-team IT design of record is retained (IT 108 active since the (ah) OMO deferral) and the deferral is recorded in the capability-sourcing register's amendment schedule (sourcing §4); consumer bulky install/haul-away (VS-143) stays covered by the in-suite Field Service dispatch core and the CCP dispatch experience layer; the squad re-stands at CAP-B01 re-enablement through W5580 | Defer vs disband the platform | Disable-not-delete: re-enablement is a checklist, never a rebuild | 
| OMO build squad (Order Orchestration) | **DEFERRED — PREPARED (2026-09-23 (ah), by direction: all sales pass through POS)** — with BOPIS the only enabled online fulfillment option (registry CAP-F01) every sale completes as a regular POS sale at the customer-selected store and order routing is deterministic; VS-60's multi-source orchestration workload is the disabled—prepared fulfillment estate (CAP-F04–F09, CAP-C03/C04); the OMO build squad's 7 seats stand down (IT 115 → **108 active**, 15 of 17 teams active), the 122-FTE 17-team design of record is retained, and the deferral is recorded in the capability-sourcing register's amendment schedule (sourcing §4); the live BOPIS path rides the already-built ecommerce platform's capability-configuration service and in-suite order flows; the squad re-stands when a second fulfillment origin or marketplace channel enables, through W5580 | Staff a build squad for deterministic single-origin routing vs defer it | Disable-not-delete: the prepared design re-activates with the second fulfillment origin; no orchestration product is needed while every sale is a POS sale |
...
*Date: 2026-09-23 (v11 — OMO build squad deferred — prepared: new Design-Decisions row — with BOPIS the only enabled online fulfillment option (registry CAP-F01) every sale completes as a regular POS sale and order routing is deterministic; by direction the OMO build squad's 7 seats defer — IT 115 → 108 active, 15 of 17 teams active, the 122-FTE 17-team design of record retained — the deferral recorded in the capability-sourcing register's amendment schedule (sourcing v3.18, OM v3.28, TO v3.2); A2.6 re-derived ~PHP 62.3B ÷ 6,911 ≈ PHP 9.01M; A6.6's seat-avoidance note re-based to ~6,911-seat. Companions: TO v3.2, profile v3.11, OM v3.28, sourcing v3.18, registry v1.5.)*
*Date: 2026-09-23 (v10 — eighty-third-wave consistency review: the A6.6 seat-avoidance note re-based — its 'IT-staff-sized licensing avoids ~6,925-seat cost' cell still carried the (x)-disablement canon after the (ad) TPS-squad deferral re-based the active population to 6,918, the half-repaired-cell class (the (x) pass had itself re-based this very cell 6,932 → 6,925); trued to ~6,918-seat. No assumption, decision, guardrail or integration change. Companions: OM v3.26, registry v1.4, sourcing v3.16.)*
*Date: 2026-09-23 (v9 — TPS build squad deferred — prepared: new Design-Decisions row — with the trade desk disabled (x), the TPS build squad's project-side workload (VS-74/VS-77) is dormant; by direction the squad's 7 seats defer — IT 122 → 115 active, 16 of 17 teams active, the 122-FTE 17-team design of record retained — the deferral recorded in the capability-sourcing register's amendment schedule (sourcing v3.15, OM v3.25, TO v3.1); consumer bulky install/haul-away stays covered by the in-suite Field Service dispatch core and the CCP dispatch experience layer; A2.6 re-derived ~PHP 62.3B ÷ 6,918 ≈ PHP 9.01M. Companions: TO v3.1, profile v3.9, OM v3.25, sourcing v3.15.)*
