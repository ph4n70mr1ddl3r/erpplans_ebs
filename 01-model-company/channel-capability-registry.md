...
| ID | Capability | Definition / scope | State | Vehicles | Enable prerequisites |
|---|---|---|---|---|---|
| CAP-B01 | **Trade & Account Management department** (the B2B selling desk) | The 7-role HQ department (Head of Trade, 2 Trade Account Managers, 2 Key Account Managers, Trade Pro Coordinator, Trade Ops & Analytics — TO §5.3): trade-account relationships, key-account plans, the project/B2B quote desk, program coordination | **DISABLED — PREPARED** (2026-09-23 (x)) | TO §5.2/§5.3 (design retained); PA-11.1 (account lifecycle), PA-11.2 (project/B2B), VS-107 (key accounts), VS-43 (Trade Pro program) | Re-staff the 7 roles per the TO §5.3 register; re-base the headcount canon (HQ 525 → 532); re-open the account estate (CAP-B02) and the program/rebate capabilities (CAP-B03/B04); re-point the volume canons from designed capacity to live load |
