...
> The **structure of record** is this document: **HQ 532 / total 6,932** at 200 stores — the full design, retained per the disable-not-delete doctrine. The **active** organization is **HQ 518 / total 6,918**: Trade / Account Management (7) is **DISABLED — PREPARED** (2026-09-23 (x); channel-capability-registry §3.4 CAP-B01) — the 7-role design below is retained, not staffed, and re-enablement is a checklist through W5580 (revised
...
```
   ...
   │                                      teams + CIO Office = 122 FTE design; 115 active — the TPS build squad deferred — prepared (ad); DPO administrative line)
   │
...
| CIO | 2 (Head of EA / portfolio, FinOps & vendor-portfolio) via CIO Office; 17 product teams of record | 115 | ✅ (platform-led span) |
| CMO | 1 + dotted GM Digital Commerce Inc. | 30 | ✅ light span absorbs retail-media growth |
| CHRO | 2 | 68 | ✅ |
| VP Legal & Compliance | 2 + CorpSec (statutory) | 24 | ✅ |
| **Total** | **17 active departments + Executive Office** (of the 18-department design; Trade disabled — prepared (x); the TPS build squad deferred — prepared (ad)) | **511 + 7 = 518** | |
...
| 5 | Information Technology | 50 | 65–130 | **122** | 17 product teams per it-product-operating-model.md §9.1 (authoritative — two-tier sourcing doctrine + agentic-AI platform, 2026-09-14; §9.1's v3.12 mix re-point: WLI's second vendor seat → in-suite WMS/OTE functional-analyst depth, one Platform Product Manager per integrate team, commodity-vendor commercial ownership in the CIO Office); **active 115 — the TPS build squad (7) deferred — prepared 2026-09-23 (ad), design retained** |
...
| | **Total HQ** | **362** | **~440–515** | **532** | Design total; active HQ **518** (Trade's 7 disabled — prepared (x); the TPS build squad's 7 deferred — prepared (ad)) |
| | Store personnel | 5,800 | OK | **5,800** | 29/store affirmed (§13) |
| | DC personnel | 600 | OK | **600** | 150/DC affirmed (§13) |
| | **Total company** | **6,762** | | **6,932** | Design total; active **6,918**; revenue/employee ≈ PHP 9.01M active (÷ 6,918) |
...
Actual = 115 active of the 122-design — the product-centric operating model is the IT department's structure of record (authoritative sizing under the two-tier capability-sourcing +
agentic model, mid-band of the 65–130 two-tier need band); the TPS build squad's 7 seats are deferred — prepared with the trade desk disabled (2026-09-23 (ad)), and the deferral is recorded in the capability-sourcing register's amendment schedule (sourcing model §4).
...
#### Information Technology (122 design; 115 active — by reference)

| Role | HC | Reports to | Mandate |
|---|---|---|---|
| IT product portfolio — 9 domain + 7 platform product teams + CIO Office | 122 | CIO | Defined in [`it-product-operating-model.md`](../07-methodology/it-product-operating-model.md) §3–§5 (team-by-team rosters, including the two in-house build squads OMO and TPS) and §9.1 (sizing authority); deliberately not restated here (single-source rule, §5.2). **115 active** — the TPS build squad's 7 seats deferred — prepared (2026-09-23 (ad); sourcing register §4 amendment); consumer bulky install/haul-away stays covered by the in-suite Field Service dispatch core and the CCP dispatch experience layer |
| **Total** | **122** | | |
...
| [`it-product-operating-model.md`](../07-methodology/it-product-operating-model.md) | Authoritative IT structure & sizing (122-FTE design, 17 product teams of record; 115 active — the TPS build squad deferred — prepared) |
