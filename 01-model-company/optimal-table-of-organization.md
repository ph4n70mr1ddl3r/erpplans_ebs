...
> this register resolves to exactly one row, and workflow presence is contracted at function
> level — every department has at least one catalog-resolved role, while specialist and
> deputy titles may legitimately be exercised through their department's broader titles (the
> generated role-coverage matrix reports per-role resolution). Owner cells written in
