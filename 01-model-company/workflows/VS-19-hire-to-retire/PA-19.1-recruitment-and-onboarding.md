...
| **Volume** | ~6,932 employees; all employees reviewed annually |
...
- **Total distributed effort**: ~6,000 hours/year across ~230 managers for ~6,932 employees

### Staffing Implication
- **No incremental headcount.** Performance reviews are distributed across ~230 managers (Store Managers, Dept. Supervisors, Dept. Heads). Annual cycle adds ~45 min/employee/year for ~6,932 employees = ~6,000 hours total effort, distributed across the management team.
...
| **Volume** | ~6,932 employees; ~20,700 sets of uniforms (3 per employee) + safety gear |
| **Owner** | HR Operations Manager |
| **Participants** | HR Assistant, Store/DC Manager, Procurement, Vendor, Employee |

### Background

With over 6,932 employees in retail and distribution, maintaining a consistent professional image and ensuring safety compliance (PPE) is a significant logistical task. BuildRight provides uniforms and mandatory safety gear (safety shoes, helmets, vests) to all store and DC personnel.
...
| **Volume** | 6,932 employee base; average ~120–180 sickness claims/month, ~40–60 maternity leaves/month, and ~250–350 loan applications/month |
...
| **Volume** | 6,932 employees across all locations |
| **Owner** | CHRO |
...
- **Geographic coverage**: Providing equitable wellness services to 6,932 employees across 200 stores in provincial and island locations is logistically challenging; health screening and face-to-face counseling require physical presence
...
- **External EAP Provider**: Outsourced. Budgeted as employee benefit cost (~PHP 300–500/employee/year × 6,932 = ~PHP 2.1–3.5M/year).
...
| **Frequency** | ~100–130 enrollment/changes/month (new hires + events); annual renewal for 6,932 employees |
| **Volume** | ~6,932 covered employees + ~2,000 dependents across 5 entities |
| **Owner** | HR Benefits Specialist |
...
| **Volume** | ~6,932 active employee records + ~100,000 former applicant records + ~20,000 former employee records under retention |
...
| **Frequency** | Ongoing (~100–150 referrals/month across 6,932 employees) |
...
| **Volume** | ~10–15 internal communications/week across 6,932 employees in 205+ locations |
...
- **Pay equity analysis complexity**: comparing compensation across 6,932 employees in 5 entities with varying regional wage orders and role-specific allowances requires careful normalization to avoid misleading conclusions
...
| **Volume** | ~200 new hires chain-wide at any given time (based on annual turnover ~40% × 6,932 employees / 12 months) |
...
| **Volume** | 6,932 employees × annual enrollment + ~200 qualifying life event changes/year |
...
Annual enrollment period: Preparation (2-3 days) + communication (4 hours) + enrollment processing (~40 hours for 6,932 employees) + verification (~20 hours) + transmission (4 hours) + audit (4 hours) = ~80–90 hours concentrated in 4-6 weeks. Ad-hoc qualifying events: ~20 min each × 200/year = ~67 hours distributed throughout year.
...
| **Frequency** | Occasional-to-rare; ~6–10 events/year chain-wide across ~6,932 employees (driver reckless-imprudence cases dominating, plus LP-referred arrests and off-duty detentions) |
