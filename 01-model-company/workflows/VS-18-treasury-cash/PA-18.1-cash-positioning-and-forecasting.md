...
| 4 | **Payroll forecast**: Payroll Manager provides payroll forecast for 4-week window — semi-monthly payroll on the 15th and 30th (~PHP 110–120M per run covering ~6,932 employees); variable components: overtime, commissions, 13th month accrual release (November–December), statutory contributions due per agency calendars (SSS by the last day of the following month per RA 11199; PhilHealth and Pag-IBIG by the 10th of the following month); special payroll runs (separation pay, backpay adjustments) | Payroll Manager | Treasury Analyst | 10 min |
