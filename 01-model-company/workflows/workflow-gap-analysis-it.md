...
4 DCs, HQ; ~6,918 employees (active; the TO's 532-design retains the disabled—prepared Trade department and the deferred—prepared TPS build squad (ad)); ~1,500 ERP users; ~2,500+ endpoints; 600 POS terminals; the in-suite
...
The single largest end-user technology estate — **~6,918 M365/email users** (cited as a volume
