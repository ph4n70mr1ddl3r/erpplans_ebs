...
| 3 | **Routing & Capacity Setup**: Logistics Manager configures the vehicle in the transportation management system (TMS), defining its route restrictions (e.g., truck ban exemptions) and maximum payload (weight/volume) for load building (W196). | Logistics Manager | — | 20 min |
