...
### Staffing Implication
- **DC Receiving Clerk**: ~3 min additional per receipt for RTP logging; with ~50 receipts/day/DC (the ~6,000/month DC goods-receipt canon, per PA-04.1/data-volumes §1.1), this adds ~2.5 hours/day across the receiving team. Absorbed.
...
| **Volume** | 4 DCs; each DC operates ~16 hours/day; ~40 inbound trucks/day + ~15–20 outbound loads/day per DC (the ~60–80 outbound loads/day chain-wide consolidated-drop canon per W836); ~150 DC staff per DC in total across two shifts (~60–80 on duty per shift) |
| **Owner** | DC Manager |
| **Participants** | DC Shift Supervisors (2 per DC), DC Receiving Supervisor, DC Dispatch Supervisor, DC Receiving Clerks, Putaway Staff, Pickers, Loaders, Quality Checkers, Yard Staff, Forklift Operators, Cross-Dock Coordinator, Gate Guard, DC Office Administrator |
...
| **Frequency** | Continuous; ~55–60 appointment slots managed per day per DC (40 inbound + 15–20 outbound) |
| **Volume** | ~1,200 inbound appointments/month per DC; ~450–600 outbound load slots/month per DC (the ~60–80 loads/day chain-wide canon); peak receiving window 8:00–10:00 AM with 15–20 inbound trucks arriving |
...
- **Gate Guard**: adds ~5 min per truck for structured check-in vs. current informal gate process; with ~55–60 trucks/day, this is ~5 hours/day across 2 guards. Absorbed within existing gate security staffing.
...
### Time Estimate
~10–15 min of scheduler effort per appointment (request intake 5–10 min + dock/slot assignment 5 min) plus 5 min gate check-in per truck, 15 min/day no-show management, 30 min/week compliance reporting, and 1 hour/month capacity planning per DC; at ~1,200 inbound + ~450–600 outbound appointments per DC-month (4 DCs ≈ 6,600–7,200/month chain-wide) ≈ 13,200–21,600 scheduling hours/year, plus gate check-ins ≈ 500 hours/year and recurring reviews ≈ 520 hours/year — total ≈ 14,200–22,600 hours/year across the 4 DC scheduling desks.
...
| **Owner** | DC Manager |
| **Participants** | DC Shift Supervisors, DC Receiving Supervisor, DC Dispatch Supervisor, VP Supply Chain, Supply Planning Manager, DC Operations Analyst |
