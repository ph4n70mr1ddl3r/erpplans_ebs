...
- **Why it matters:** ~3.2–3.6M punch events/year feed the W10/W816 payroll of 6,918 employees —
...
- **Evidence:** '2316' appears in **10 PA files / 22 hits with zero dedicated `## W` headers**.
  ...
  W2765 the annual 1604E/1604C + alphalist — but the furnishing campaign to ~6,918 employees, its
