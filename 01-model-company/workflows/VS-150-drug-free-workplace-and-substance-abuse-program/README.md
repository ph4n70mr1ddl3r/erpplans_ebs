# VS-150: Drug-Free Workplace & Substance Abuse Program
...
covered employers to formulate and implement a drug-free workplace policy and program. At ~6,918
...
Today this discipline is **unowned as a program**. "drug test", "drug-free workplace", "substance
abuse", "reasonable suspicion", and "random drug testing" appear in **zero** PA files as dedicated
workflow headers (only scattered single-step mentions). The capability is sprinkled inside VS-83
(Occupational Health — touches the *clinic/exam* side), VS-19.1 (Recruitment — touches
...
disciplinary/legal (NLRC) handling, EAP/rehabilitation referral, return-to-work agreements,
confidentiality (RA 10173) & records, audit/inspection readiness, and deterrence analytics.

This is distinct from **VS-83 (Occupational Health)** which owns the *clinic/exam* operation — this
value stream owns the *drug-free program* that uses the clinic/lab as a vendor. It is distinct from
**VS-19.1 (Recruitment)** which owns the *onboarding transaction* — this value stream owns
...
well-run program is also a deterrence and a rehabilitation pathway (not purely punitive), aligned
with DOLE's emphasis on rehabilitation.
...
| PA | Name | Workflows |
|---|---|---|
| [PA-150.1](PA-150.1-drug-free-workplace-policy-framework-and-dole-compliance.md) | Drug-Free Workplace Policy, Framework & DOLE Compliance | 8 |
| [PA-150.2](PA-150.2-drug-testing-operations-results-and-case-management.md) | Drug Testing Operations, Results & Case Management | 8 |
| [PA-150.3](PA-150.3-rehabilitation-return-to-duty-privacy-and-program-analytics.md) | Rehabilitation, Return-to-Duty, Privacy & Program Analytics | 8 |
| | **Total** | **24** |
