...
- **Staff welfare check coverage**: HR must verify safety of ~6,762 employees across affected regions within 24 hours; if cellular networks are down (common after typhoons), welfare checks default to physical visits that may take days to complete
...
*Counts below reflect the rebalanced HQ staffing (profile §3.3; total HQ = 362). Finance, IT, HR, and Legal were increased from the prior lean baseline to resolve the capacity contradictions flagged in their own validation notes (e.g., AP "10 clerks" cannot fit a 35-person team; IT archipelago field support flagged inadequate). Store (5,800) and DC (600) counts are unchanged; six previously un-enumerated functions (HSE, Quality, Facilities & Real Estate, Sustainability/ESG, Strategy, Trade Account Management) are now explicit in the profile.*
...
| **IT** | Infrastructure, Apps, Data, Security, BI Analyst, Helpdesk | ~50 | W16 (store setups), W35 (reporting), W48 (helpdesk & IT ops) | ✅ 4–5 helpdesk agents + 3–4 specialists handle ~800–1,200 tickets/month; 2–3 per store setup + BAU support; 1 BI Analyst supports management reporting; note: for physical IT support across the Philippine archipelago (200 stores + 4 DCs across Mindanao, Visayas, Luzon), 1–2 dedicated field staff may not provide adequate same-day response for P1 incidents in remote locations — recommend (a) training designated Store Managers as first-level hardware troubleshooters (certified on basic POS terminal swap, cable reseat, network restart), (b) contracting regional IT service providers in each major region (Davao, Cebu, Manila, Clark) for emergency on-site support, and (c) maintaining a spare POS terminal and network equipment swap stock at each DC for rapid dispatch |
| **HSE, Quality, Facilities, ESG, Strategy, Trade Acct Mgmt, Regional LP** | Safety officers/nurse, incoming inspection & metrology, facilities & lease admin, ESG reporting, corporate planning, trade program, LP Officers | ~53 | W140–W141 (HSE), W31 (quality/incoming inspection), W47 (facilities), W25.x (ESG), W33.x (strategy), W43.x (trade program), VS-23 (loss prevention) | ✅ The six previously un-enumerated functions (profile §3.3: HSE 10, Quality 4, Facilities & Real Estate 8, Sustainability/ESG 3, Strategy 3, Trade/Account Management 5) plus the 20 Regional LP Officers — completing the table reconciliation to the 362 HQ total |
| **Other** | Legal, Internal Audit, DPO, Regulatory Officer, Customer Service (call center), Executive | ~58 | W41 (complaints), W42 (audit observation), W53 (data privacy breach, DSAR lifecycle, data portability/erasure), W54 (LGU permits), W54A (BIR CAS registration), W62 (vendor contracts) | ✅ Support functions; call center handles multi-channel complaint intake; Legal expanded to include DPO (W53 with full DSAR lifecycle) and Regulatory Officer (W54 LGU + W54A BIR CAS); total Legal & Compliance is 14 per profile §3.3 (incl. the DPO and Regulatory Officer) |
...
| **Volume** | ~6,762 employees across 200 stores |
| **Owner** | Store Manager |
...
- **Employee data privacy awareness**: with 6,762 employees across 200 stores, ensuring consistent privacy practices at the store level is challenging; mitigated by annual mandatory training (Step 7) and simple POS-level procedures for customer data handling
