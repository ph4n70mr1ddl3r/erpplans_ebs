...
- **Staff welfare check coverage**: HR must verify safety of ~6,918 employees across affected regions within 24 hours; if cellular networks are down (common after typhoons), welfare checks default to physical visits that may take days to complete
...
| **Volume** | ~6,918 employees across 200 stores |
| **Owner** | Store Manager |
...
- **Employee data privacy awareness**: with 6,918 employees across 200 stores, ensuring consistent privacy practices at the store level is challenging; mitigated by annual mandatory training (Step 7) and simple POS-level procedures for customer data handling
