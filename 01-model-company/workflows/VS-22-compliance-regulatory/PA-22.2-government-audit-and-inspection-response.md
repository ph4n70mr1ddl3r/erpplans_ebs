...
| **Participants** | Tax Accountant, Controller, CFO, Chief Accountant, AP Clerk, AR Clerk, IT, Legal, external tax advisor, BIR Revenue Officers, Operations Compliance Lead |
...
### System Touchpoints
- In-house Audit & GRC platform compliance-case tracking (BUILD — fit-gap H11): case logging, evidence attachment, deadline tracking, status management (W469.2)
...
| **Volume** | ~6,911 employees across 5 entities; annual testing targets ~20–30% random sample (~1,300–2,000 tests/year) |
...
- Store compliance-audit cycle managed in the in-house Audit & GRC platform (BUILD — fit-gap H11)
...
- In-house Audit & GRC platform compliance-case tracking (BUILD — fit-gap H11)
