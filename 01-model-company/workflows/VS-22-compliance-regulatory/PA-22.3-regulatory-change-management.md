...
| # | Activity | Role (R) | Role (A) | Duration |
|---|---|---|---|---|
| 1 | Store and DC associates segregate waste: Carton, Stretch Film (Plastic), Wood (Pallets), Scrap Metal | Associates | — | Ongoing |
...
- iRecruitment (fit-gap E2) for local hiring coordination with Barangay referrals
...
| **Volume** | ~6,918 employees (annual training); ~800–1,000 vendors (due diligence); ~200 LGUs (interaction points) |
| **Owner** | Compliance Officer |
