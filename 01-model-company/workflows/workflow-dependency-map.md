...
| VS-133 Operational Excellence, Process Mining & Continuous Improvement Program | Continuous-improvement OS over the ~5,427 workflows; mines ERP event logs (VS-15/VS-10/VS-04); shares benefit tracking with VS-17.4 and VS-135. Depends on VS-21 (audit), VS-17, VS-30 (innovation). |
