...
| VS-141 Employee Transport, Shuttle & Daily Commute Management | Daily people-movement for ~6,925 staff; distinct from business travel (VS-19.1), goods fleet (VS-06), and facilities (VS-138); allowance via payroll (VS-19.2)/comp (VS-102), vendor via VS-34/VS-56, safety via VS-24. Depends on VS-19, VS-103, VS-34. |
