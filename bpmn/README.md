...
- Control flow is rendered as the **documented sequence**; conditional logic embedded in step
  ...
  (5,450 judgment calls), not something to fake mechanically.
...
*Generated by `07-methodology/generate-bpmn.py` · source corpus: 5,450 workflow blocks across 188 value streams / 569 process areas*
