...
validator — 85 checks, run in CI and before every publish) enforces, at minimum, these check
classes:
...
the reference corpus grew it to 85 checks, each one the scar tissue of a real defect.
