...
> Companion to [`it-product-operating-model.md`](it-product-operating-model.md) (v3.24): how
...
a represented role; the Change & Training Lead pool carries rollout for the 6,925-user base.

## 13. Related Documents

| Document | Relationship |
|---|---|
| [`it-product-operating-model.md`](it-product-operating-model.md) | The operating model this sourcing strategy reshapes (v3.24: 17 teams incl. AAP, archetypes per the two-tier doctrine, SEP, SIB, 122 FTE — the IT department's structure of record; active headcount re-based 6,925 with the Trade department disabled — prepared, registry CAP-B01) |
