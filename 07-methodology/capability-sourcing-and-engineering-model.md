...
> Companion to [`it-product-operating-model.md`](it-product-operating-model.md) (v3.26): how
...
|---|---|
| [`it-product-operating-model.md`](it-product-operating-model.md) | The operating model this sourcing strategy reshapes (v3.26: 17 teams of record incl. AAP — 16 active, the TPS build squad deferred — prepared — archetypes per the two-tier doctrine, SEP, SIB, 115 FTE active of the 122-design — the IT department's structure of record; active headcount re-based 6,918 with the Trade department disabled — prepared (registry CAP-B01) and the TPS build squad deferred — prepared on this register's §4 amendment) |
