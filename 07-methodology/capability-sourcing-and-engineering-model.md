...
> Companion to [`it-product-operating-model.md`](it-product-operating-model.md) (v3.14): how
...
| **Tier 2** (3,299) | **Bounded autonomy** | Agent acts inside hard guardrails (limits, whitelists, value caps); sampled human audit; auto-escalation on anomaly |
...
1. **Candidate intake** — the per-workflow Automation Opportunity inventory (5,430 workflows)
...
|---|---|
| [`it-product-operating-model.md`](it-product-operating-model.md) | The operating model this sourcing strategy reshapes (v3.14: 17 teams incl. AAP, archetypes per the two-tier doctrine, SEP, SIB, 122 FTE — the IT department's structure of record) |
