...
> Companion to [`it-product-operating-model.md`](it-product-operating-model.md) (v3.25): how
...
| **Build** (squads) | OMO; TPS deferred — prepared (ad) — plus the doctrine's new build scope (Payroll PH, store workforce, dispatch), squad/remit assignment at SIB/OM | Product Manager, Tech Lead, 3–4 software engineers, QA automation engineer; shared UX/product designer (SEP pool); matrixed IAP engineer and DP data analyst |
...
a represented role; the Change & Training Lead pool carries rollout for the 6,918-user base.

## 13. Related Documents

| Document | Relationship |
|---|---|
| [`it-product-operating-model.md`](it-product-operating-model.md) | The operating model this sourcing strategy reshapes (v3.25: 17 teams of record incl. AAP — 16 active, the TPS build squad deferred — prepared — archetypes per the two-tier doctrine, SEP, SIB, 115 FTE active of the 122-design — the IT department's structure of record; active headcount re-based 6,925 with the Trade department disabled — prepared, registry CAP-B01) |
