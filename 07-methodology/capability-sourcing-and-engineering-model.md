...
> Companion to [`it-product-operating-model.md`](it-product-operating-model.md) (v3.13): how
...
- **Vendor commodities** (LLM APIs, managed SOC, outsourced L1 contact center, hardware and
  ...
  posture for the doctrine's commodity-only vendor estate.
...
|---|---|
| [`it-product-operating-model.md`](it-product-operating-model.md) | The operating model this sourcing strategy reshapes (v3.13: 17 teams incl. AAP, archetypes per the two-tier doctrine, SEP, SIB, 122 FTE — the IT department's structure of record) |
