...
> Companion to [`it-product-operating-model.md`](it-product-operating-model.md) (v3.15): how
...
|---|---|
| [`it-product-operating-model.md`](it-product-operating-model.md) | The operating model this sourcing strategy reshapes (v3.15: 17 teams incl. AAP, archetypes per the two-tier doctrine, SEP, SIB, 122 FTE — the IT department's structure of record) |
