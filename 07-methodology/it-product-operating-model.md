...
> [`capability-sourcing-and-engineering-model.md`](capability-sourcing-and-engineering-model.md) (v3.14).
...
| 16 | Field & End-User Services | FS | Platform | All 205 locations; 6,925 users | 1 | 24 |
...
| **Change & Training Lead** | Shared pool under HR (Training) with CIO Office funding | ~0.25–0.5 FTE per team | Training curriculum and materials per release, adoption metrics, floor-walking for major rollouts — essential for 6,925 users of varying tech literacy across the archipelago. |
...
| Industry benchmark | 100–168 (1.5–2.5% of the 6,925 active headcount); lean outsourced floor ~60–70 | `headcount-reality-check.md` §3.2 |
...
(+7) — still mid-band (65–130), because agents substitute for task hours across the 6,925-user
...
| [`capability-sourcing-and-engineering-model.md`](capability-sourcing-and-engineering-model.md) | The sourcing decision gate, Capability Sourcing Register, build-squad engineering standard, and SEP definition this v3.24 model is built on |
...
12-team design at 80 FTE. Downstream: `optimal-table-of-organization.md` v3.0 (HQ 525 active /
total 6,925 active — Trade / Account Management disabled — prepared 2026-09-23 (x); the 532/6,932 design retained; census population re-pointed at batch 30), `model-company-profile.md` v3.8,
`technical-guidelines.md` v3.6,
`capability-sourcing-and-engineering-model.md` v3.14.*
