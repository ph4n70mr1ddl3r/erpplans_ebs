...
> [`capability-sourcing-and-engineering-model.md`](capability-sourcing-and-engineering-model.md) (v3.4).
...
(188 value streams, 569 process areas, 5,430 workflows).
...
| **Total** | **171 + 17 = 188** | **4,935 + 495 = 5,430** |
...
| [`capability-sourcing-and-engineering-model.md`](capability-sourcing-and-engineering-model.md) | The sourcing decision gate, Capability Sourcing Register, build-squad engineering standard, and SEP definition this v3.14 model is built on |
...
`capability-sourcing-and-engineering-model.md` v3.4.*
