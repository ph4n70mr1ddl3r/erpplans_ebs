...
> [`capability-sourcing-and-engineering-model.md`](capability-sourcing-and-engineering-model.md) (v3.20).
...
| [`capability-sourcing-and-engineering-model.md`](capability-sourcing-and-engineering-model.md) | The sourcing decision gate, Capability Sourcing Register, build-squad engineering standard, and SEP definition this v3.30 model is built on |
...
12-team design at 80 FTE. Downstream: `optimal-table-of-organization.md` v3.4 (HQ 511 active /
...
`capability-sourcing-and-engineering-model.md` v3.20.*
