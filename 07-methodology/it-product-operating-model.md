...
> [`capability-sourcing-and-engineering-model.md`](capability-sourcing-and-engineering-model.md) (v3.17).
...
| 16 | Field & End-User Services | FS | Platform | All 205 locations; 6,918 users | 1 | 24 |
...
squads on the SEP paved road (sourcing model §5–§7); the TPS squad is **deferred — prepared** (2026-09-23 (ad)) with the trade desk disabled — the shape below is its prepared design for re-enablement, and consumer bulky install/haul-away stays covered by the in-suite Field Service dispatch core and the CCP dispatch experience layer:
...
| **Change & Training Lead** | Shared pool under HR (Training) with CIO Office funding | ~0.25–0.5 FTE per team | Training curriculum and materials per release, adoption metrics, floor-walking for major rollouts — essential for 6,918 users of varying tech literacy across the archipelago. |
...
### 6.4 Build-squad delivery (OMO; TPS deferred — prepared)
...
- **Build (OMO; TPS deferred — prepared (ad)):** continuous delivery on the SEP ring model (internal → canary
...
### 9.1 Steady-state design (122 IT FTE design; 115 active)
...
| **Domain subtotal** | 9 | 8 | 22 | 9 | 6 | 9 | 3 | — | **59 active** (66 design incl. the deferred TPS squad) |
...
> platform team. **v3.25: the TPS build squad's 7 seats defer — prepared (2026-09-23 (ad)) with the trade desk disabled — domain 59 + platform/CIO 56 = 115 active; the 122-design is retained** The v3.12 mix re-point (§5.1/§5.4) converts WLI's second product/vendor
...
| Industry benchmark | ~104–173 (1.5–2.5% of the 6,918 active headcount); lean outsourced floor ~60–70 | `headcount-reality-check.md` §3.2 |
...
(+7) — still mid-band (65–130), because agents substitute for task hours across the 6,918-user
...
### 9.3 Phased build-up (50 → 122 design; 115 active)
...
| [`capability-sourcing-and-engineering-model.md`](capability-sourcing-and-engineering-model.md) | The sourcing decision gate, Capability Sourcing Register, build-squad engineering standard, and SEP definition this v3.27 model is built on |
...
12-team design at 80 FTE. Downstream: `optimal-table-of-organization.md` v3.1 (HQ 518 active /
total 6,918 active — Trade / Account Management disabled — prepared 2026-09-23 (x); the TPS build squad deferred — prepared 2026-09-23 (ad); the 532/6,932 design retained; census population re-pointed at batch 30), `model-company-profile.md` v3.10,
`technical-guidelines.md` v3.7,
`capability-sourcing-and-engineering-model.md` v3.17.*
