...
> [`capability-sourcing-and-engineering-model.md`](capability-sourcing-and-engineering-model.md) (v3.13).
...
| [`capability-sourcing-and-engineering-model.md`](capability-sourcing-and-engineering-model.md) | The sourcing decision gate, Capability Sourcing Register, build-squad engineering standard, and SEP definition this v3.23 model is built on |
...
total 6,925 active — Trade / Account Management disabled — prepared 2026-09-23 (x); the 532/6,932 design retained; census population re-pointed at batch 30), `model-company-profile.md` v3.7,
`technical-guidelines.md` v3.5,
`capability-sourcing-and-engineering-model.md` v3.13.*
