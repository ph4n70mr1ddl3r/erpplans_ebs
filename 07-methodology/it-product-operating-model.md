...
> [`capability-sourcing-and-engineering-model.md`](capability-sourcing-and-engineering-model.md) (v3.12).
...
| [`capability-sourcing-and-engineering-model.md`](capability-sourcing-and-engineering-model.md) | The sourcing decision gate, Capability Sourcing Register, build-squad engineering standard, and SEP definition this v3.22 model is built on |
...
12-team design at 80 FTE. Downstream: `optimal-table-of-organization.md` v2.9 (HQ 532 /
total 6,932 — the actual structure of record, gap-filled 2026-09-18; census population re-pointed at batch 30), `model-company-profile.md` v3.6,
`technical-guidelines.md` v3.4,
`capability-sourcing-and-engineering-model.md` v3.12.*
