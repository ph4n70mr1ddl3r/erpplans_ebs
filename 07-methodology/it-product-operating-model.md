...
> [`capability-sourcing-and-engineering-model.md`](capability-sourcing-and-engineering-model.md) (v3.9).
...
(188 value streams, 569 process areas, 5,432 workflows).
...
| | CIO Office (EA, Portfolio Governance, FinOps, Vendor Portfolio) | CIO | Enabling | CIO; CEO; Finance | 3 | 84 |
| | **Platform + CIO subtotal** | | | | **17** | **495** |
| | **Total** | | | | **188** | **5,432** |
...
| CIO Office | 3 (VS-30, VS-113, VS-135) | 84 |
| **Total** | **171 + 17 = 188** | **4,937 + 495 = 5,432** |
...
| [`workflows/value-stream-index.md`](../01-model-company/workflows/value-stream-index.md) | The 188-VS / 569-PA / 5,432-WF catalog this model assigns to products |
...
| [`capability-sourcing-and-engineering-model.md`](capability-sourcing-and-engineering-model.md) | The sourcing decision gate, Capability Sourcing Register, build-squad engineering standard, and SEP definition this v3.19 model is built on |
...
12-team design at 80 FTE. Downstream: `optimal-table-of-organization.md` v2.8 (HQ 532 /
total 6,932 — the actual structure of record, gap-filled 2026-09-18), `model-company-profile.md` v3.4,
`technical-guidelines.md` v3.4,
`capability-sourcing-and-engineering-model.md` v3.9.*
