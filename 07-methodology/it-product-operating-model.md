...
> [`capability-sourcing-and-engineering-model.md`](capability-sourcing-and-engineering-model.md) (v3.16).
...
| [`capability-sourcing-and-engineering-model.md`](capability-sourcing-and-engineering-model.md) | The sourcing decision gate, Capability Sourcing Register, build-squad engineering standard, and SEP definition this v3.26 model is built on |
...
total 6,918 active — Trade / Account Management disabled — prepared 2026-09-23 (x); the TPS build squad deferred — prepared 2026-09-23 (ad); the 532/6,932 design retained; census population re-pointed at batch 30), `model-company-profile.md` v3.9,
`technical-guidelines.md` v3.7,
`capability-sourcing-and-engineering-model.md` v3.16.*
