...
ANCHORS = ["| Employees | 6,918 active (Trade / Account Management disabled — prepared (x); the IT estate's TPS build squad deferred — prepared (ad); the TO design holds 532 HQ) |", "| Active SKUs | 35,000 |",
