...
ANCHORS = ["| Employees | 6,911 active (Trade / Account Management disabled — prepared (x); the IT estate's TPS build squad deferred — prepared (ad) and the OMO build squad deferred — prepared (ah); the TO design holds 532 HQ) |", "| Active SKUs | 35,000 |",
