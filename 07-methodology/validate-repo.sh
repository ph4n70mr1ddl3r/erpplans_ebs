...
vehicle_literals = [
    ...
    (r'demand planning module', 'retired generic demand-planning vehicle (adopted: Demantra on the ASCP planning stack — fit-gap C5)'),
