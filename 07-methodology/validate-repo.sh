...
case "$C71_CENSUS_OUT" in
  *"CENSUS workflows=5433 owner_resolved=5433 owner_uncharted=0 owner_uncharted_forms=0 uncharted_forms=0 ctl_owner_cells=808 ctl_owner_resolved=808 ctl_owner_uncharted=0 ctl_owner_uncharted_forms=0 prose_role_uncharted=0 prose_role_forms=0 anchor_chartered=259 anchor_anchored=259 anchor_zero=0 anchor_weak=62"*) C71_CENSUS_OK=1;;
esac
