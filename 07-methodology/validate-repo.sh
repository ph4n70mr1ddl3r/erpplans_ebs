...
vehicle_literals = [
    ...
    (r'(?i)(?<!yield/)revenue module', 'retired generic revenue vehicle (adopted: Oracle Revenue Management and Invoicing/RM&I — fit-gap A11; the forty-fifth-wave review trued the VS-157 ST rows and the PA-13.1/14.1/15.1 rows; the storage-PMS yield module stands as VS-174 domain naming)'),
    ...
    (r'[Rr]evenue recognition module', 'retired generic revenue vehicle (adopted: Oracle Revenue Management and Invoicing — fit-gap A11)'),
    (r'Revenue Recognition Module', 'retired generic revenue vehicle (adopted: Oracle Revenue Management and Invoicing — fit-gap A11)'),
    (r'ERP Subscription Billing module', 'retired generic subscription vehicle (adopted: Oracle Revenue Management and Invoicing — fit-gap A11)'),
    ...
    (r'Compliance case management system', 'retired generic compliance-case vehicle (adopted: Oracle Internal Controls Manager — fit-gap H11)'),
