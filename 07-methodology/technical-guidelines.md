...
| 6,925 employees | Core HR lives in the on-premises EBS suite; statutory payroll is computed on the in-house Payroll PH build on BuildRight-run infrastructure — nothing rides a public cloud (the platform of record is not a cloud/SaaS ERP) |
...
| HQ | 1 | ≥ 200 Mbps | ~525 active HQ staff (≈473 concurrent users at the ~90% ratio; the TO's 532-role design retains the disabled—prepared Trade department), reporting, batch processing |
