...
| Driver | Value | Source |
|---|---|---|
| Total employees | **6,911** (5,800 store + 600 DC + 511 HQ) | profile §4 (Trade / Account Management disabled — prepared 2026-09-23 (x); the IT estate's TPS build squad deferred — prepared 2026-09-23 (ad) and the OMO build squad deferred — prepared 2026-09-23 (ah); the designs are retained, TO §5.3) |
| ERP authorized (named) users | **3,511** → licensed **3,600** | build-up below |
| — HQ staff | 511 active of the 532-role design (all 18 departments touch the ERP; Trade / Account Management's 7 disabled — prepared 2026-09-23 (x); the IT estate's TPS build squad's 7 deferred — prepared 2026-09-23 (ad) and the OMO build squad's 7 deferred — prepared 2026-09-23 (ah)) | profile §3.3 |
...
Report (A85655 @ $6, min 1,000), not the Application User — the 636-filer population (all HQ
511 active of the 532-role design + DC office staff ~100 + district/region field ~25) files
~12 reports/yr ≈ 7,600, licensed
...
whose GPL metric is the Trainee (any person recorded by the program) — the 6,911 basis
...
| | USD list |
|---|---:|
| **Perpetual license total** | **$50,210,920** |
| Annual SUL&S (22%) | $11,046,402/yr |
| 3-yr TCO (license + 3× support) | $83,350,126 |
| 5-yr TCO (license + 5× support) | **$105,442,930** |
...
*Suite Employee tier = the employee population outside the professional tier: 6,911 − 3,600 =
3,311 (§1 drivers; the §1 Employee-metric rule governs the HRMS product lines, not this bundle
...
|---|---:|---:|---:|---:|
| **A — EBS 12.2 perpetual + 22% SUL&S** | $50.21M | $11.05M (support) | $83.4M | $105.4M |
| **B1 — Fusion Cloud à-la-carte** | — | $29.00M | $87.0M | $145.0M |
| **B2 — Fusion Suite bundle (36-mo)** | — | $23.09M | $69.3M | $115.4M |

1. **At list price, EBS is cheapest over 5 years** (~$105.4M vs $115.4M Suite / $145.0M
