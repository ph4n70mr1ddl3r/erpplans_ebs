...
| Driver | Value | Source |
|---|---|---|
| Total employees | **6,918** (5,800 store + 600 DC + 518 HQ) | profile §4 (Trade / Account Management disabled — prepared 2026-09-23 (x); the IT estate's TPS build squad deferred — prepared 2026-09-23 (ad); the designs are retained, TO §5.3) |
| ERP authorized (named) users | **3,518** → licensed **3,600** | build-up below |
| — HQ staff | 518 active of the 532-role design (all 18 departments touch the ERP; Trade / Account Management's 7 disabled — prepared 2026-09-23 (x); the IT estate's TPS build squad's 7 deferred — prepared 2026-09-23 (ad)) | profile §3.3 |
...
> product therefore licenses 6,918, even if only managers use it.
...
Report (A85655 @ $6, min 1,000), not the Application User — the 643-filer population (all HQ
518 active of the 532-role design + DC office staff ~100 + district/region field ~25) files
~12 reports/yr ≈ 7,700, licensed
...
### 2.8 HRMS — all Employee-metric @ 6,918

| Product | Part # | List $/emp | License $ |
|---|---|---:|---:|
| Human Resources (PER) | L31953 | 185 | 1,279,830 |
| Self-Service Human Resources | L31958 | 40 | 276,720 |
| Advanced Benefits (OAB) | A92408 | 85 | 588,030 |
| Compensation Workbench | L46808 | 70 | 484,260 |
| iRecruitment | L31969 | 75 | 518,850 |
| Performance Management | L46799 | 105 | 726,390 |
| Time and Labor | A92407 | 110 | 760,980 |
| Succession Planning | L74875 | 70 | 484,260 |
| Learning Management (OLA) | L44374 | 105 | 726,390 |
...
whose GPL metric is the Trainee (any person recorded by the program) — the 6,918 basis
...
| | USD list |
|---|---:|
| **Perpetual license total** | **$50,216,835** |
| Annual SUL&S (22%) | $11,047,704/yr |
| 3-yr TCO (license + 3× support) | $83,359,947 |
| 5-yr TCO (license + 5× support) | **$105,455,355** |

*Full-implementation delta vs v1.0: **+$702,215** of perpetual license (+$154,487/yr support)
...
would add $225/emp × 6,918 = **$1,556,550** (+$342,441/yr support).*
...
| Fusion HCM Base (Global HR/absence/benefits) | B85800 | Hosted Employee | 15 | 6,918 | 103,770 |
| Fusion Time and Labor | B75365 | Hosted Named User | 3 | 3,000 | 9,000 |
| Fusion Workforce Compensation (CWB eq.) | B109620 | Hosted Comp. Individual | 4 | 6,918 | 27,672 |
| Fusion Learning (OLA eq.) | B85242 | Hosted Named User | 5 | 6,918 | 34,590 |
| Fusion Recruiting (iRecruitment eq.) | B87675 | Hosted Employee | 8 | 6,918 | 55,344 |
| Fusion Talent Management (perf + succession) | B94925 | Hosted Named User | 7 | 6,918 | 48,426 |
...
**B1 totals: $29,004,024/yr · $87,012,072 (3-yr) · $145,020,120 (5-yr)**
...
| Fusion Suite Employee (self-service tier) | B108675 | Hosted Employee | 5 | 3,318 | 16,590 |
...
| Fusion S&OP Cloud | B91061 | Hosted Named User | 625 | 15 | 9,375 |
| Fusion Time and Labor | B75365 | Hosted Named User | 3 | 3,000 | 9,000 |
| Fusion Learning | B85242 | Hosted Named User | 5 | 6,918 | 34,590 |
| Fusion Recruiting | B87675 | Hosted Employee | 8 | 6,918 | 55,344 |
| Fusion Talent Management | B94925 | Hosted Named User | 7 | 6,918 | 48,426 |
| Fusion Workforce Compensation | B109620 | Hosted Comp. Individual | 4 | 6,918 | 27,672 |
...
**B2 totals: $23,090,364/yr · $69,271,092 (3-yr) · $115,451,820 (5-yr)**

*Suite Employee tier = the employee population outside the professional tier: 6,918 − 3,600 =
3,318 (§1 drivers; the §1 Employee-metric rule governs the HRMS product lines, not this bundle
...
5. All quantities include a ~3% growth buffer but assume 200 stores / 6,918 employees —
