...
blocks both platforms (Employee-metric 7,247 ≥ the 6,918 canon); payroll excluded on both
...
| Total employees (Employee metric) | 7,247 | 9,271 | 6,918 | HR/HCM blocks (RFQ ≥ canon — conservative ✓) |
...
*Document Version: 1.3 | Date: 2026-09-23 | **TPS build squad deferred — prepared (2026-09-23 (ad)): the §3 employee-metric canon.** The quote-coverage employee canon re-bases 6,925 → 6,918 (525 → 518 HQ; the TPS build squad's 7 deferred — prepared; OM v3.25); the RFQ ≥ canon conservatism verdicts stand (7,247 / 9,271 ≥ 6,918). No quote-total, decision or restatement change. Prior 1.2 |
