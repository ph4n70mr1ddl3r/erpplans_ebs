...
| [`fit-gap-analysis.md`](fit-gap-analysis.md) | The gap discipline: fit classes (FIT-STD/FIT-CFG/PER/EXT/LOC/INT/BUILD; EDGE retired), the capability disposition register (90 rows incl. the 2026-09-15 and 2026-09-16 EBS-exhaustion audits: Field Service dispatch core, Lease & Finance Management, Internet Expenses, Teleservice, Advanced Benefits — then eAM, Procurement Contracts, Revenue Management & Invoicing (retiring the PFRS 15 extension), Global Order Promising, Oracle Configurator (in-store), In-Memory Cost Management, GL budgetary control and Oracle Alert), the resolution record for the formerly-open buy decisions, the Philippine statutory split (EBS-held vs payroll-built), requirement-section (R1–R32) disposition view, and the standard-first KPIs |
