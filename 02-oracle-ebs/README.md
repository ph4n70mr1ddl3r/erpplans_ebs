...
| [`ebs-vision-verification.md`](ebs-vision-verification.md) | Live verification of this documentation set against the designated ERP system of record — the Oracle EBS 12.2.12 Vision instance: platform footprint conformance (every register vehicle checked against the instance's 176-product registry and responsibility catalog), five transactional smoke tests through the standard interface/API paths, and the findings register (VF-1 … VF-6) with the required documentation corrections |
