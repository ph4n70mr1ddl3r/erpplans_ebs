...
> AWS/Azure-console touchpoint against the on-premises deployment canon); and the 2026-09-16 **seventh-pass adopted-vehicle corpus sweep** trued the generic vehicle rows the six passes' own adoptions had superseded — the workflows outside the re-pointed files that still said 'audit management system / GRC module' (now ICM), 'facility maintenance module / CMMS' (now eAM), 'lease management module' (now Property Manager), 'contract management system' (now Procurement Contracts on the vendor side), 'warranty module' (now Install Base), 'rebate module' (now Trade Management), 'expense modules' (now iExpenses), 'bank reconciliation module' (now Cash Management), 'ATP module' (now GOP), 'benefits / performance management / recruitment modules' (now OAB / Performance Management / iRecruitment) — including the adoption passes' own cited workflows whose rows had been left generic (W808, W27, W89, W74-referencing rows), with no new rows and no disposition movement (§4 resolution 31); and the 2026-09-16 **eighth-pass corpus sweep & LMS posture true** named the remaining adopted-vehicle classes — the 'Inventory/ATP system' availability rows (now GOP, the stock-status/alert senses INV, per D15), the 'demand planning module' rows (now Demantra per C5), the four 'Transportation Management System (TMS)' rows (now in-suite Shipping/Transportation Execution per C14), and the generic quality-system rows (now Oracle Quality per C12) — and trued W5525's learning-platform administration onto the in-suite OLA per §4 resolution 5, retiring the corpus's vendor-SaaS posture vocabulary (annual vendor renewal & SLA review, vendor account manager seat, vendor upgrades) against the 'deeper function is built — never bought' canon, with the vehicle-sense LMS touchpoints corpus-wide naming OLA and PA-22.1's L&D cross-reference repaired W74 → W51 (no new rows, no disposition movement — §4 resolution 32).
...
| A4 | Bank statement reconciliation | Cash Management (CE) auto-reconciliation | FIT-STD | W89, W537/W541 feeds. The 2026-09-16 seventh-pass corpus sweep named Cash Management in W89's own statement-import step and reconciliation row (PA-17.4) and W1468's sweep-matching row (PA-08.2) |
...
| B10 | Vendor rebates, promotions & claims (VS-39, W27, W161) | PO accruals + Trade Management evaluation | FIT-CFG | **Resolved in-suite per §4 resolution 3**: Oracle Trade Management is the vehicle (license cost is a FinOps decision, not a sourcing decision); PO accruals remain the staging surface feeding OTM claims. The 2026-09-16 seventh-pass corpus sweep named Trade Management in W27's own rebate rows (step, ST and automation mirror in PA-03.3) and the W300 promotional-rule master row |
| B11 | Employee expense reports & the corporate-card program (W74, PA-15.2 card reconciliation) | Internet Expenses (iExpenses): expense reports, receipt upload, policy limits, AME approvals, GL/cost-center coding; AP card-program statement loads | FIT-CFG | The 2026-09-15 exhaustion audit names the vehicle the W74 self-service claim form assumed: expense capture, policy validation and card-statement reconciliation are native; reimbursement lines flow to payroll/AP as today. The 2026-09-16 seventh-pass corpus sweep named iExpenses in PA-27.3's 'ERP AP & Expense modules' row (W7, W74) |
| B12 | Vendor contract authoring, clause governance, deliverables & expiry/compliance tracking (W62/W62B lifecycle, W669 compliance monitoring & enforcement, W241 facility-vendor SLAs) | **Oracle Procurement Contracts** — contract authorship from the standard clause library, deliverables with due dates, expiration/amendment alerts, integration with PO agreements and receipts | FIT-CFG | The 2026-09-16 second-pass audit names the vehicle the W669 'contract management module' touchpoint assumed: authoring, deliverables and compliance tracking are native; legal review rides W230 with the contract record as evidence spine. Serves W669, W155 JBP terms, W513 vendor-funded-promo terms, W62/W62B 3PL & services contracts, W241 cleaning/security/canteen SLAs. The 2026-09-16 seventh-pass corpus sweep named the product in the vendor-contract rows that still said 'contract management system/module': W402's contract-ingestion step (vendor-trade-agreement side; the in-house CLM register keeps leases and B2B/customer agreements per DOC-011), W230-referencing rows in PA-20.2/PA-21.1, W2560's anti-counterfeit clause library, W1013's 3PL SLA deliverables and PA-03.1's packaging-sustainability clause enforcement |
...
| C5 | Statistical forecasting, S&OP/IBP surface (W31, W133, VS-127) | **Oracle ASCP + Demantra** (EBS-family Value Chain Planning stack) | FIT-CFG | Resolved per the two-tier doctrine — the planning stack is Oracle's, so we use it; license cost is a FinOps decision, not a sourcing decision. The 2026-09-16 second-pass audit names the same stack's **Inventory Optimization** (multi-echelon) and **Rapid Planning** engines for VS-136's network/MEIO engineering (W4129–W4136) — same adoption, same FinOps posture. The 2026-09-16 eighth-pass corpus sweep named Demantra in the seasonal demand-planning rows still generic (PA-01.1's two seasonal-planning ST rows and the substitution-forecast feed, PA-02.1's PAGASA weather-feed row, PA-03.4's W31 seasonal-index step, PA-11.2's B2B forecast-collection step and ST row, PA-30.2's forecast-accuracy engine) |
...
| C12 | Incoming inspection, supplier quality data (W110, VS-31) | Oracle Quality collection plans | FIT-STD | CAPA workflow on quality notices; deep QMS stays process. The 2026-09-16 eighth-pass corpus sweep named Oracle Quality in the generic quality-system rows: PA-01.1's QA-lab results-recording step with its automation mirror and its 'ERP Quality Management module' ST row, PA-03.1's and PA-22.1's 'ERP Quality module' rows, and PA-67.3's quality-system dimension (the supplier-side 'quality management system review' instances stand — they assess the vendor's own system) |
...
| C14 | Transport planning, carrier tendering & freight audit (VS-06, VS-110) | Shipping Execution + Transportation Execution (in-suite) | FIT-STD | The register's BoB TMS row is superseded — tender, ship-confirm and freight-cost capture are in-suite; optimization beyond OTE is a build candidate, never a buy. The 2026-09-16 eighth-pass corpus sweep named the in-suite execution stack in the corpus's four 'Transportation Management System (TMS)' rows (PA-15.1's freight-audit shipment/rate-card row, PA-29.1's vehicle routing & capacity step, PA-02.3's shipment-tracking row, PA-11.3's W62B 3PL-booking row) |
...
| E2 | Recruitment, self-service, learning, performance & succession (W51 training, W72 performance cycle, W178 succession & internal mobility, VS-121) | iRecruitment + Self-Service HR + **Performance Management (appraisals/objectives)** + **Succession Planning (talent pools, readiness states, career paths — W178)** + OLA | FIT-STD | In-suite per the doctrine; a deeper build is the doctrine-compliant path if adoption ever lags. The 2026-09-16 fourth-pass audit names the appraisal vehicle the W72 ST rows left generic — goals as objectives, annual assessments as appraisals with routed approval and ERES signature evidence on the Core HR person record. The 2026-09-16 fifth-pass audit names the succession vehicle the W178 ST rows left generic — HiPo identification as talent-pool tagging, 'Ready Now / Ready in 1–2 Years' mapping as readiness states, IDP/career paths on the succession plan record, internal-posting alerts via iRecruitment. The 2026-09-16 seventh-pass corpus sweep named the vehicles in sibling rows: W1127's re-certification reviews → Performance Management, W209's local hiring → iRecruitment. The 2026-09-16 eighth-pass corpus sweep named the learning-platform vehicle: W5525's LMS administration runs on the in-suite OLA per §4 resolution 5 — the vendor-SaaS posture vocabulary (annual vendor renewal & SLA review, vendor account manager seat, vendor upgrades, single-vendor-outage SLA mitigation) retired against the 'deeper function is built — never bought' canon — and the vehicle-sense LMS touchpoints across the training/enablement/compliance corpus name OLA (enumeration labels, the registered W5525 title and the external/vendor LMS instances stand) |
...
| E9 | Benefits enrollment, eligibility & life events (VS-102.2) | Advanced Benefits (OAB): plan/enrollment/eligibility design, life-event processing | FIT-CFG | The 2026-09-15 exhaustion audit names the vehicle the 'Benefits administration platform' touchpoint assumed; Oracle Payroll stays unadopted — OAB communicates deduction envelopes to Payroll PH through the E4 feed. The 2026-09-16 seventh-pass corpus sweep named OAB in W778's benefits open-enrollment row (VS-19.1) — the same enrollment/eligibility/life-event capability the VS-102.2 adoption carries |
...
| F3 | Lease administration, rent/CAM/indexation, real-property tax (W117/W118/W119) | Property Manager leases, payment schedules, indexation | FIT-STD | Critical-date workflows; PFRS-16 accounting via A12 The 2026-09-16 seventh-pass corpus sweep named Property Manager in the generic 'lease management module' rows: W807 lease termination (PA-20.1), W1183 CAM reconciliation & escalations (PA-20.1) and W1854 lease registration (PA-42.1, step + ST) |
...
| 31 | The adopted-vehicle class swept to its end across the corpus (2026-09-16 seventh pass): the generic 'audit management system / GRC module / facility maintenance module / lease management module / contract management system / warranty module / rebate module / expense module / bank reconciliation module / ATP module / benefits module / performance management module / recruitment module' vehicle rows that the six audit passes' adoptions superseded — ICM (H11), eAM (F5), Property Manager (F3), Procurement Contracts (B12), Trade Management (B10), iExpenses (B11), OAB (E9), Performance Management/iRecruitment (E2), Cash Management (A4), GOP (D15), Install Base (D16) | **Trued to the adopted products**; no new rows, no disposition changes, standard share unchanged (74 = 76.3%) | Register-row note extensions (H11, D16, B12, B10, B11, E2, E9, A4, D15, F5, F3) |
| 32 | The remaining adopted-vehicle classes named and the learning-platform posture trued (2026-09-16 eighth pass): the 'Inventory/ATP system' availability rows (D15 GOP; the stock-status/alert senses ride INV), the 'demand planning module' rows (C5 Demantra), the 'Transportation Management System (TMS)' rows (C14 in-suite Shipping/Transportation Execution), the generic quality-system rows (C12 Oracle Quality), and W5525's vendor-SaaS LMS posture (E2 OLA per resolution 5 — vendor renewal/SLA/account-manager/upgrade vocabulary retired; the vehicle-sense LMS touchpoints name OLA) | **Trued to the adopted products**; no new rows, no disposition changes, standard share unchanged (74 = 76.3%) | Register-row note extensions (C5, C12, C14, D15, E2); the corpus's 'LMS per W74' L&D cross-reference mis-point repaired to W51 in PA-22.1; the role-coverage matrix's 'Lms Vendor Account Manager' seat retired (4,201 → 4,200 resolved actors) |
