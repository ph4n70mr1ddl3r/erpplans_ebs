...
*Document Version: 2.5 | Date: 2026-09-23 | **OMO build squad deferred — prepared (2026-09-23 (ah)): the UAT/TRAIN estate row.** The training-estate sizing re-bases 6,918 → 6,911 users with the active population (HQ 511; the OMO build squad's 7 deferred — prepared with every sale completing as a regular POS sale; OM v3.28). No component, integration or deployment change. Prior 2.4 |
