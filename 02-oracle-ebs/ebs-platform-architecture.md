...
| **Oracle HRMS (PER)** | Org/position/employee master, EITs (licenses, PPE sizes), absence types, performance appraisals/objectives (W72 review cycle) | VS-19, W15/W43, W72, W292 — Core HR stays in EBS; the payroll engine is the in-house build (below) |
