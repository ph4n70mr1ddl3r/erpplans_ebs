...
| 10 | Employees + assignments + EITs | 6,925 headcount (200×29 stores + 600 DC + 525 HQ active; Trade / Account Management's 7 disabled — prepared, registry CAP-B01) | `HR_PERSON_API`/assignment APIs + EIT loads | W4 — per mapping §2.x |
