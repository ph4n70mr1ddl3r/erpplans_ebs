...
| 23 | Maintainable asset & equipment register (facility equipment, DC MHE, tool-rental fleet, measurement/calibration devices, EVSE, renewable assets) | FA asset register + equipment logs & PM calendars | eAM asset import (FA-linked instance numbers); PM schedules, activity codes and calibration attributes (fit-gap F5, §4 resolution 13) | W5 — PM generation verified against the equipment register before go-live |
