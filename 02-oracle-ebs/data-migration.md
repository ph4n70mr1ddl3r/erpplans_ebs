...
| 10 | Employees + assignments + EITs | 6,932 headcount (200×29 stores + 600 DC + 532 HQ) | `HR_PERSON_API`/assignment APIs + EIT loads | W4 — per mapping §2.x |
...
| 24 | Internal-control register (CTL-01–CTL-808) | 808 controls | Internal Controls Manager (ICM) control-library load — objective/activity/owner/workflow mapping from the [internal-controls matrix](../01-model-company/internal-controls-matrix.md) (fit-gap H11, §4 resolution 30) | W0 — before the first assessment cycle |
...
```
W0  Foundation setup (rows 1–3) + the control register into ICM (24)
